...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_IRQS, 71);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_SAM_TWIHS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PSN_JLINK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY_SAM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_PART_NUMBER_SAME70J19, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_ATMEL_SAME70_MDIV, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_ATMEL_SAME70_PLLA_MULA, 24);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_ATMEL_SAME70_PLLA_DIVA, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_HAS_CANFD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_HAS_RX_TIMESTAMP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_FD_MODE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CANFD_MAX_DLC, 15);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_WORKQ_FRAMES_BUF_CNT, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_RX_TIMESTAMP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_AUTO_BUS_OFF_RECOVERY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_SAM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_SAM_CKDIV, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_MCAN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_DELAY_COMP, 1);
